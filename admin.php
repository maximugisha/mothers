            ...
            <table class="min-w-full table-auto">
                ...
                <?php foreach ($users as $user): ?>
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <select onchange="updateUserRole(<?php echo $user['id']; ?>, this.value)" class="border rounded px-2 py-1">
                        ...
                        <td class="px-4 py-2">
                            <button onclick="editUser(<?php echo $user['id']; ?>)" class="text-blue-500 hover:text-blue-700 mr-2">Edit</button>
